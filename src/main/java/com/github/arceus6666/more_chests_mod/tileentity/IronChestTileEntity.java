package com.github.arceus6666.more_chests_mod.tileentity;

import javax.annotation.Nonnull;

import com.github.arceus6666.more_chests_mod.block.IronChestBlock;
...
public class IronChestTileEntity extends LockableLootTileEntity {
  ...
  public IronChestTileEntity() {
    this(ModTileEntityTypes.IRON_CHEST.get());
  }
  ...
  protected ITextComponent getDefaultName() {
    return new TranslationTextComponent("container.iron_chest");
    // return new TranslationTextComponent("Iron Chest");
  }
  ...
  public static void swapContents(IronChestTileEntity te, IronChestTileEntity otherTe) {
